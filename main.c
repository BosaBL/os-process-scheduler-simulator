...
int main(int argc, char **argv) {
  ...
  // FT_ROW_HEADER); ft_write_ln(table, "Algorithm", "ProccesQTY", "totalTime",
  // "IdleTime",
  ...
  //                np_priority_data->idleTime,
  //                np_priority_data->avgResponseTime,
  ...
  //                pp_priority_data->idleTime,
  //                pp_priority_data->avgResponseTime,
  ...
  // ft_set_cell_prop(table2, 0, FT_ANY_COLUMN, FT_CPROP_ROW_TYPE,
  // FT_ROW_HEADER); ft_set_cell_prop(table2, 1, FT_ANY_COLUMN,
  ...
  //   ft_write_ln(table2, "Process", "FinishTime", "TurnAroundTime",
  //               "WaitingTime", "FinishTime", "TurnAroundTime",
  //               "WaitingTime");
  //
  //   for (int i = 0; i < *(proc_qty); i++) {
  //     Process p0 = process_data_array[0][i];
